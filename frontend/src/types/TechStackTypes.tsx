...
export const TechStackTypes = [
  { tech: "Microsoft Excel", icon: <StackIcon name="microsoft" className="h-5 w-5" /> },
  ...
  { tech: "CSS3", icon: <StackIcon name="css3" className="h-5 w-5" /> },
  { tech: "HTML5", icon: <StackIcon name="html5" className="h-5 w-5" /> },
];
